  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen w-full flex items-center justify-center bg-transparent px-6 overflow-hidden">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
        <h2 className="text-3xl sm:text-5xl md:text-8xl lg:text-9xl tracking-tighter text-black uppercase leading-none text-center flex flex-col items-center">
          ...
          <div className="overflow-hidden w-fit">
            <motion.div
              ...
              className="flex items-baseline gap-x-2 sm:gap-x-4 px-2 leading-[1.1]"
            >
